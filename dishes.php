...
<body>
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/Logo.jpeg" alt=""
    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a
                            href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your Product</a></li>
        ...
        ?>
        <section class="inner-page-hero bg-image" data-image-src="images/img/bg1_1.png">
            <div class="profile">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0"
                                            value=<?php echo "Rs" . $item["price"]; ?> readonly id="exampleSelect1">
                                    </div>
                                    <div class="col-xs-4">
                                    ...
                                    <a
                                        href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=decrement&id=<?php echo $item["d_id"]; ?>">
                        ...
                        <div class="dropdown-menu1">
                            <button class="menu-btn">Sort by < </button>
                                    <div class="menu-content">
                                        <?php echo '<a class="links-hidden" href="dishes_sortby_price.php?res_id=' . $_GET['res_id'] . '">Price</a>'; ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-lg-3  item-cart-info">
                                            ...
                                            <input class="b-r-0" type="number" name="quantity"
                                                style="margin-left:20px;width:40%; padding: 2px 0 2px 4px ;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;"
                                                value="1" size="1" min="0" />

                                            <input type="submit" class="btn theme-btn"
                                                style="margin-left:40px;margin-top:10px;" value="Add To Cart" />
                                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-3" style="margin-left: 0px;">
                        <a href="#" target="_blank">
                            <img src="images/masinagudi.jpg" class="img-responsive" alt="Masinagudi Image"
                                style="height: 180px; width: 100%; margin-bottom: 10px;">
                        </a>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 address">
                                ...
                                <p class="text-center">Masinagudi Village, Tribal Cooperative Society building, Near
                                    Ooty Main Town, PIN: 643223</p>
                            </div>

                            <div class="col-xs-12 col-sm-5 additional-info">
                                <h5 class="text-center">Contact</h5>
                                <p class="text-center">Tribal Research Center, Nanjanad Road, Muttorai Palada, Ooty,
                                    Tamil Nadu, 634004, India</p>
                            ...
                            <div class="col-xs-12 col-sm-3">
                                <a href="#" target="_blank">
                                    <img src="images/TRC.jpg" class="img-responsive" alt="TRC Image"
