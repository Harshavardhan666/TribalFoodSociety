    ...
    <!-- <footer class="footer">
        <div class="container">
            <div class="bottom-footer">
                <div class="row">
                    <div class="col-md-2 col-sm-12 text-center" style="margin-top: 25px;">
                        <a href="#" target="_blank">
                            <img src="images/masinagudi.jpg" class="img-fluid" alt="Masinagudi Image" style="height: 130px; width: 230px;">
                        </a>
                    </div>
                    <br>
                    ...
                    <div class="col-md-2 col-sm-12">
                        <div class="social-links color-gray">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="#" class="fa fa-facebook"> Like us on Facebook</a></li>
                                <li><a href="#" class="fa fa-twitter"> Follow us on Twitter</a></li>
                                <li><a href="#" class="fa fa-instagram"> Follow us on Instagram</a></li>
                                <li><a href="#" class="fa fa-linkedin"> Follow us on LinkedIn</a></li>
                                <li><a href="#" class="fa fa-youtube"> Follow us on YouTube</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-12">
                        <div class="support color-gray">
                            <h5>Support</h5>
                            <p>If you have any questions or you need our help,</p>
                            <p>you can contact us through our</p>
                            <p>
                                <a href="#">
                                    <input type="button" value="SUPPORT SITE" style="background-color: #303036; border: 1; border-color: white; color: white;">
                                </a>
                            </p>
                        </div>
                    </div>
